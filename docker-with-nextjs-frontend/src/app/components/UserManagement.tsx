...
const UserManagement = ({users}: any) => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-black">
      <h1 className="text-4xl font-extrabold text-center text-white mt-6">User Management Page</h1>
      <div className="flex-grow flex justify-center items-center">
        <div className="card">
          <button onClick={handleOpenAddUserModal} className="bg-green-500 text-white py-2 px-4 rounded mb-4">
            Add User
          </button>
      ...
      {/* Add User Modal */}
      <AddUserModal state={state} formAction={formAction} isOpen={isModalOpen} onClose={handleCloseModal} />
    </div>
  );
};
